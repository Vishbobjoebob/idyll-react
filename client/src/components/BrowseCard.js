...
export default function BrowseCard(props) {
    ...
    return (
        <>
            {/* as={Link} to={`/details?id=${props.id}`} style={{textDecoration: 'none', color: 'black'}}  */}
            <div className="overall-container" style={{position: 'relative'}}>
                ...
                <Card id="card-container" as={Link} to={`/details?id=${props.id}`} style={{textDecoration: 'none', color: 'black'}}> 
